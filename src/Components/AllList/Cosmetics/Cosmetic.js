...
const Cosmetic = (props) => {
    const { _id, name, image, category, price, features } = props.cosmetic;
            ...
            <div className="col h-100">
                <div style={{ backgroundColor: "#D5D6EA" }} className="cardbox w-100 card h-100">
                    ...
                    <div class="card-footer bg-transparent border-success d-flex justify-content-between">
                        ...
                        <Link style={{ textDecoration: "none" }} className="link d-flex justify-content-center" to={`cosmeticOrder/${_id}`} ><button className="btn btn-success " >
                            <i style={{ color: "red", fontSize: "20px" }} class="fa fa-cart-plus"></i>
                            <span className="ps-1"> ORDER</span>
                        </button>
                        </Link>

                        <Link style={{ textDecoration: "none" }} className="link d-flex justify-content-center" to={`cosmeticdetails/${_id}`} ><button className="btn btn-info ">
                            <i style={{ color: "red", fontSize: "20px" }} class="fa fa-cart-plus"></i>
