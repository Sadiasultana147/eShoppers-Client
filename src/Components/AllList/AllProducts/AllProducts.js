        ...
        <div>
            {
                ...
                <div className="row row-cols-1 row-cols-md-3 row-cols-lg-3 g-5 d-flex justify-content-center mb-5 pb-5  ">
                    ...
                    {
                        fashions.map(product => <AllProduct key={product._id} product={product}
                    ...
                    {
                        sports.map(product => <AllProduct key={product._id} product={product}
                    ...
                    {
                        electronics.map(product => <AllProduct key={product._id} product={product}
                    ...
                    {
                        cosmetics.map(product => <AllProduct key={product._id} product={product}
                    ...
                    {
                        furnitures.map(product => <AllProduct key={product._id} product={product}
